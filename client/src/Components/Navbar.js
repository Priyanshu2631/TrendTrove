    ...
    <div>
      <nav className="bg-darkblue p-3 fixed w-full top-0 z-50 shadow-sm">
        <motion.div
          ...
          className="container mx-auto md:flex md:justify-between md:items-center"
        >
          ...
          {user && (
            <div className=" text-white border px-3 py-1">{user.name}</div>
          )}
          {user && (
            <button
              onClick={handleLogout}
              className="text-white border px-3 py-1 hover:text-blue-300"
            >
              Logout
            </button>
          )}
          {!user && (
            <button
              ...
              className="border px-4 py-1 rounded-full bg-white text-indigo-950 hover:bg-darkblue hover:text-white border-white"
            >
              Login
            </button>
          )}
